...
public class IPAddressGenerator {
	...
	public static List<String> generateAllPossibleValidIPAddresses(String digits) {
		...
		return List.of(0, 1, 2, 3)
			...
			.filter(ipAddress -> isValidIPAddress(ipAddress))
	...
	public static void main(String[] args) {
		...
		List<String> ipAddresses = generator.generateAllPossibleIPAddresses(digits);

		System.out.println("All possible valid IP addresses for the given steing of digits are: ");
